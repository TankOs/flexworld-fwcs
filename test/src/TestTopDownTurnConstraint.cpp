...
BOOST_AUTO_TEST_CASE( TestTopDownTurnConstraint ) {
	...
	// Update rotation, ignoring axes except y.
	{
		...
		/*source_rotation *= util::FloatQuaternion::from_angle_axis( util::deg_to_rad( 20.0f ), util::axis_vector<util::Axis::X>() );
		source_rotation *= util::FloatQuaternion::from_angle_axis( util::deg_to_rad( 40.0f ), util::axis_vector<util::Axis::Z>() );*/
