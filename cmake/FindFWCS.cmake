...
if( FWCS_LIBRARY_RELEASE AND NOT FWCS_LIBRARY_DEBUG )
	set( FWCS_LIBRARY_DEBUG ${FWCS_LIBRARY_RELEASE} )
	set( FWCS_LIBRARY ${FWCS_LIBRARY_RELEASE} )
endif()

if( FWCS_LIBRARY_DEBUG AND NOT FWCS_LIBRARY_RELEASE )
	set( FWCS_LIBRARY_RELEASE ${FWCS_LIBRARY_DEBUG} )
